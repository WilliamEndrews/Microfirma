...
export type OpcoesDesenharAtores = {
  /** Nomes exibidos no nameplate (fallback: agentId curto). */
  nomes?: ReadonlyMap<string, string> | null;
  /** Destaque visual do agente selecionado (anel no pe). */
  selecionadoId?: string | null;
  /** Desenha nameplates acima dos agentes (default true). */
  nameplates?: boolean;
};
...
/**
 * Hit-test: devolve o agentId mais a frente (maior x+y) sob o ponto em
 * coordenadas da cena (mesmo espaco de `origem` + iso).
 */
